...
urlpatterns = [
    ...
    path('online_Booking_info/', views.online_Booking_info, name='online_Booking_info'),
    path('Edit_online_Booking/<int:id>/', views.Edit_online_Booking, name='Edit_online_Booking'),
    ...
    path('AddCustpage_Delete/<int:id>/', views.AddCustpage_Delete, name='AddCustpage_Delete'),
    path('AllCustpage_Delete/<int:id>/', views.AllCustpage_Delete, name='AllCustpage_Delete'),

    path('AddEmplopage_Delete/<int:id>/', views.AddEmplopage_Delete, name='AddEmplopage_Delete'),
    path('Add_Employee_Search/', views.Add_Employee_Search, name='Add_Employee_Search'),
    path('AllEmployee_Delete/<int:id>/', views.AllEmployee_Delete, name='AllEmployee_Delete'),

    path('Add_room/', views.Add_room, name='Add_room'),
    path('Add_Room_Search/', views.Add_Room_Search, name='Add_Room_Search'),
    path('AddRooms_Delete/<int:id>/', views.AddRooms_Delete, name='AddRooms_Delete'),
    path('EditRooms/<int:id>/', views.EditRooms, name='EditRooms'),
    path('All_Room/', views.All_Room, name='All_Room'),
    path('AllRooms_Delete/<int:id>/', views.AllRooms_Delete, name='AllRooms_Delete'),
